/**
 * @file lv_conf.h
 * LVGL v8.3.x configuration for Hotel Room Thermostat
 * Hardware: ESP32-S3 4848S040, ST7701S 480x480, 8MB OPI PSRAM
 */
...
/*=========================
   MEMORY SETTINGS
 *=========================*/
/* Use PSRAM for LVGL heap — 8MB available, plenty for complex UIs */
...
#define LV_LAYER_SIMPLE_BUF_SIZE          (240 * 1024)
...
/* Declare our SquareLine custom font */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(ui_font_fontinterlight80)
